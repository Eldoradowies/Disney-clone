      ...
      <div className="flex justify-center items-center">
        <div className="absolute flex flex-col space-y-3 top-1/4 w-full justify-center items-center max-w-screen-sm mx-auto p-8 -mt-16">
          ...
          <p className="text-xs text-center ">
            Get Premier Access to Black Panther: Wakanda Forever for an
            additional fee with a Disney+ subscription. As of 11/05/22, the
            price of Disney+ and The Disney Bundle will increase by ₦2500
          </p>
          <Image
